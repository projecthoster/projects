...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	    function Game(mode) {
	        ...
	        this.view = new _gameView2.default(this);
	        if ($("#checkAI").prop("checked")) {
	            this.player2.setAI(true);
	            new _ai2.default(this, this.view);
	        }
	    ...
	    _createClass(Game, [{
	        key: 'setTurnCallback',
	        value: function setTurnCallback(objToCallOn, callback) {
	        ...
	        key: 'setActivePiece',
	        value: function setActivePiece(pieceObject) {
	            if (this.activePiece) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	AI.AIexecute = function () {
	    ...
	    if (AI.gView.removingPiece) {
	        ...
	        if (AI.game.phase === _game2.default.PHASE_1) {
	            // PHASE 1
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function () {
	    function Board() {
	        ...
	        this.points = [];
	        for (var i = 0; i < 24; i++) {
	            this.points.push(new _point2.default());
	        }
	    ...
	    _createClass(Board, [{
	        ...
	        key: 'movePieceToPoint',
	        value: function movePieceToPoint(piece, point) {
	            if (piece.getPoint()) {
	        ...
	        key: 'checkLines',
	        value: function checkLines(activePoint) {
	            for (var i = 0; i < 2; i++) {
	        ...
	        key: 'setUpLines',
	        value: function setUpLines() {
	            for (var i = 0; i < 16; i++) {
	                this.lines.push(new _line2.default());
	            }
...
/***/ function(module, exports) {
	...
	var Point = function () {
	    ...
	    _createClass(Point, [{
	        ...
	        key: "setAdjacents",
	        value: function setAdjacents(point0, point1, point2, point3) {
	        ...
	        key: "findAdjacentPlayerPiecesNotInLine",
	        value: function findAdjacentPlayerPiecesNotInLine(line, player) {
	            var pieces = [];
	        ...
	        key: "findAdjacentsNotInLine",
	        value: function findAdjacentsNotInLine(line) {
	            var adjacents = [];
	        ...
	        key: "findAdjacentPiecesOfPlayer",
	        value: function findAdjacentPiecesOfPlayer(player) {
	            var piecesArray = [];
	            for (var i = 0; i < this.myAdjacents.length; i++) {}
	        }
	    }, {
	        key: "isAdjacent",
	        value: function isAdjacent(pointObj) {
	        ...
	        key: "setDomRef",
	        value: function setDomRef(newDomRef) {
...
/***/ function(module, exports) {
	...
	var Line = function () {
	    ...
	    _createClass(Line, [{
	        key: "setPoints",
	        value: function setPoints(point0, point1, point2) {
	        ...
	        key: "isAlmostMill",
	        value: function isAlmostMill(player) {
	        ...
	        key: "containsPlayerPieces",
	        value: function containsPlayerPieces(playerToCheck) {
	            for (var i = 0; i < 3; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameView = function () {
	    ...
	    _createClass(GameView, [{
	        key: 'generateUIElements',
	        value: function generateUIElements() {
	            var boardDiv = $("#board");
	            this.boardPaper = (0, _raphael2.default)(boardDiv.offset().left - GameView.PIECE_AREA_WIDTH, boardDiv.offset().top, GameView.BOARD_WIDTH + GameView.PIECE_AREA_WIDTH * 2, GameView.BOARD_HEIGHT);
	        ...
	        value: function createPoints() {
	            ...
	            for (var i = 0; i < this.game.board.points.length; i++) {
	                ...
	                point.getDomRef().mousedown(function () {
	            ...
	            if (clickedElement.point) {
	                ...
	                if (this.removingPiece) {
	                    if (clickedElement.piece.getColor() != this.game.activePlayer.getColor() && clickedElement.piece.getOnBoard()) {
	                        ...
	                        clickedElement.piece.getColor() === oneColor ? clickedElement.attr({
	                            cx: this.graveyards[2].x - this.graveyards[2].count++ * pieceOffset,
	                            cy: this.graveyards[2].y
	                        }) : clickedElement.attr({
	                            cx: this.graveyards[1].x + this.graveyards[1].count++ * pieceOffset,
	                ...
	                if (this.game.phase === _game2.default.PHASE_1) {} else if (this.game.phase === _game2.default.PHASE_2) {
	        ...
	        value: function refresh() {
	            ...
	            if (this.game.phase == _game2.default.PHASE_2 && this.game.gameOver()) {
	                this.gameOver();
	            }
	        ...
	        value: function updateUI() {
	            ...
	            if (this.game.phase === _game2.default.PHASE_2) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = function () {
	    function Player() {
	        ...
	        this.color = new _color2.default(Player.colors[Player.colorSelector++ % 2]);
	        this.AI = false;
	        this.pieces = [];
	        this.nonActivePieces = [];
	        this.activePieces = [];
	        for (var i = 0; i < 9; i++) {
	            this.pieces[i] = new _piece2.default(this);
	    ...
	    _createClass(Player, [{
	        key: 'setAI',
	        value: function setAI(boolAI) {
	            this.AI = boolAI;
	        }
	    }, {
	        key: 'getAssociatedLines',
	        value: function getAssociatedLines() {
	            var myLines = [];
	        ...
	        value: function takeAction() {
	            if (this.AI) {
	                _ai2.default.AIexecute();
	            }
	        }
	    }, {
	        key: 'addActivePiece',
	        value: function addActivePiece(piece) {
	        ...
	        key: 'allPiecesInMills',
	        value: function allPiecesInMills() {
	            for (var i = 0; i < this.activePieces.length; i++) {
	        ...
	        key: 'removeActivePiece',
	        value: function removeActivePiece(piece) {
...
/***/ function(module, exports) {
	...
	var Piece = function () {
	    ...
	    _createClass(Piece, [{
	        ...
	        key: "setPoint",
	        value: function setPoint(newLocation) {
