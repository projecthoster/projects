...
Board.prototype.getPoint = function(ind) {
...
Board.prototype.movePieceToPoint = function ( piece, point ) {
	if(piece.getPoint()) {
...
Board.prototype.checkLines = function( activePoint ) {
	for(var i = 0; i < 2; i++) {
...
Board.prototype.setUpPoints = function() {
	// Set up Adjacents  (maybe AdjacentFinder.js class?)
...
Board.prototype.setUpLines = function() {
	for(var i = 0; i < 16; i++) {
